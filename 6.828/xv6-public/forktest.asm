...
main(void)
{
  ...
  exit();
   b:	e8 34 03 00 00       	call   344 <exit>
...
printf(int fd, char *s, ...)
{
  ...
  30:	e8 2f 03 00 00       	call   364 <write>
}
  ...
  60:	0f 84 97 00 00 00    	je     fd <forktest+0xbd>
{
  ...
  70:	74 4e                	je     c0 <forktest+0x80>
    pid = fork();
  72:	e8 c5 02 00 00       	call   33c <fork>
    if(pid < 0)
  ...
  82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(wait() < 0){
  88:	e8 bf 02 00 00       	call   34c <wait>
  ...
  if(wait() != -1){
  97:	e8 b0 02 00 00       	call   34c <wait>
...
printf(int fd, char *s, ...)
{
  ...
  df:	e8 80 02 00 00       	call   364 <write>
      exit();
  }
  ...
  if(n == N){
    printf(1, "fork claimed to work N times!\n", N);
    exit();
  e4:	e8 5b 02 00 00       	call   344 <exit>
  }
  ...
  f8:	e8 13 ff ff ff       	call   10 <printf>
      exit();
  fd:	e8 42 02 00 00       	call   344 <exit>
    }
  }
 ...
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 29 02 00 00       	call   344 <exit>
 11b:	90                   	nop
 11c:	90                   	nop
 11d:	90                   	nop
 11e:	90                   	nop
