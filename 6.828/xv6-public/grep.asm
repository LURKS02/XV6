...
main(int argc, char *argv[])
{
  ...
  3d:	e8 32 05 00 00       	call   574 <open>
  ...
  61:	e8 f6 04 00 00       	call   55c <close>
  if(argc <= 2){
    grep(pattern, 0);
    exit();
  }
  ...
  exit();
  6b:	e8 c4 04 00 00       	call   534 <exit>
    exit();
  }
  ...
  85:	e8 f6 05 00 00       	call   680 <printf>
      exit();
  8a:	e8 a5 04 00 00       	call   534 <exit>
    exit();
  }
  pattern = argv[1];
  ...
  9a:	e8 61 01 00 00       	call   200 <grep>
    exit();
  9f:	e8 90 04 00 00       	call   534 <exit>
{
  int fd, i;
  char *pattern;
  ...
  b3:	e8 c8 05 00 00       	call   680 <printf>
    exit();
  b8:	e8 77 04 00 00       	call   534 <exit>
  bd:	90                   	nop
  be:	90                   	nop
  bf:	90                   	nop
...
grep(char *pattern, int fd)
{
 ...
 237:	e8 10 03 00 00       	call   54c <read>
 ...
 2a3:	e8 ac 02 00 00       	call   554 <write>
...
00000420 <gets>:
 ...
 443:	e8 04 01 00 00       	call   54c <read>
...
00000480 <stat>:
 ...
 496:	e8 d9 00 00 00       	call   574 <open>
 ...
 4ab:	e8 dc 00 00 00       	call   58c <fstat>
 4b0:	89 1c 24             	mov    %ebx,(%esp)
 4b3:	89 c6                	mov    %eax,%esi
 4b5:	e8 a2 00 00 00       	call   55c <close>
...
000005e0 <printint>:
 ...
 65a:	e8 f5 fe ff ff       	call   554 <write>
...
00000680 <printf>:
 ...
 6c6:	e8 89 fe ff ff       	call   554 <write>
 ...
 736:	e8 19 fe ff ff       	call   554 <write>
 ...
 753:	e8 fc fd ff ff       	call   554 <write>
 ...
 7e0:	e8 6f fd ff ff       	call   554 <write>
 ...
 810:	e8 3f fd ff ff       	call   554 <write>
 ...
 860:	e8 ef fc ff ff       	call   554 <write>
...
00000900 <malloc>:
 ...
 96a:	e8 4d fc ff ff       	call   5bc <sbrk>
