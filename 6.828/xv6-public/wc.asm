...
main(int argc, char *argv[])
{
  ...
  2d:	e8 c2 03 00 00       	call   3f4 <open>
  ...
  4f:	e8 88 03 00 00       	call   3dc <close>
  if(argc <= 1){
    wc(0, "");
    exit();
  }
  ...
  exit();
  59:	e8 56 03 00 00       	call   3b4 <exit>
    exit();
  }
  ...
  73:	e8 98 04 00 00       	call   510 <printf>
      exit();
  78:	e8 37 03 00 00       	call   3b4 <exit>
main(int argc, char *argv[])
{
  int fd, i;
  ...
  8c:	e8 0f 00 00 00       	call   a0 <wc>
    exit();
  91:	e8 1e 03 00 00       	call   3b4 <exit>
  96:	90                   	nop
  97:	90                   	nop
  98:	90                   	nop
  99:	90                   	nop
...
wc(int fd, char *name)
{
  ...
  d6:	e8 f1 02 00 00       	call   3cc <read>
 ...
 17d:	e8 8e 03 00 00       	call   510 <printf>
    exit();
 182:	e8 2d 02 00 00       	call   3b4 <exit>
 187:	90                   	nop
 188:	90                   	nop
 189:	90                   	nop
 18a:	90                   	nop
...
gets(char *buf, int max)
{
 ...
 2c3:	e8 04 01 00 00       	call   3cc <read>
    if(cc < 1)
...
stat(char *n, struct stat *st)
{
 ...
 316:	e8 d9 00 00 00       	call   3f4 <open>
  if(fd < 0)
...
stat(char *n, struct stat *st)
{
 ...
 32b:	e8 dc 00 00 00       	call   40c <fstat>
  close(fd);
 ...
 333:	89 c6                	mov    %eax,%esi
  close(fd);
 335:	e8 a2 00 00 00       	call   3dc <close>
  return r;
...
00000470 <printint>:
 ...
 4ea:	e8 e5 fe ff ff       	call   3d4 <write>
...
00000510 <printf>:
 ...
 556:	e8 79 fe ff ff       	call   3d4 <write>
 ...
 5c6:	e8 09 fe ff ff       	call   3d4 <write>
 ...
 5e3:	e8 ec fd ff ff       	call   3d4 <write>
 ...
 670:	e8 5f fd ff ff       	call   3d4 <write>
 ...
 6a0:	e8 2f fd ff ff       	call   3d4 <write>
 ...
 6f0:	e8 df fc ff ff       	call   3d4 <write>
...
00000790 <malloc>:
 ...
 7fa:	e8 3d fc ff ff       	call   43c <sbrk>
