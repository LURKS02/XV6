...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      2c:	e8 b3 3c 00 00       	call   3ce4 <open>
  ...
  exit();
     125:	e8 7a 3b 00 00       	call   3ca4 <exit>
     12a:	90                   	nop
     12b:	90                   	nop
     12c:	90                   	nop
     12d:	90                   	nop
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     152:	e8 b5 3b 00 00       	call   3d0c <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     162:	e8 ad 3b 00 00       	call   3d14 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     176:	e8 79 3b 00 00       	call   3cf4 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     186:	e8 89 3b 00 00       	call   3d14 <chdir>
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    exit();
     1bb:	e8 e4 3a 00 00       	call   3ca4 <exit>
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
    exit();
  }
  if(chdir("/") < 0){
    ...
    exit();
     1d5:	e8 ca 3a 00 00       	call   3ca4 <exit>
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
    exit();
  }
  if(unlink("../iputdir") < 0){
    ...
    exit();
     1ef:	e8 b0 3a 00 00       	call   3ca4 <exit>
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
    exit();
  }
  if(chdir("iputdir") < 0){
    ...
    exit();
     209:	e8 96 3a 00 00       	call   3ca4 <exit>
...
exitiputtest(void)
{
  ...
  pid = fork();
     22b:	e8 6c 3a 00 00       	call   3c9c <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     23d:	e8 ca 3a 00 00       	call   3d0c <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     251:	e8 be 3a 00 00       	call   3d14 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     261:	e8 8e 3a 00 00       	call   3cf4 <unlink>
    ...
    exit();
     26a:	e8 35 3a 00 00       	call   3ca4 <exit>
     26f:	90                   	nop
  }
  wait();
     270:	e8 37 3a 00 00       	call   3cac <wait>
  printf(stdout, "exitiput test ok\n");
    ...
    if(unlink("../iputdir") < 0){
     ...
     2a0:	e8 5b 3b 00 00       	call   3e00 <printf>
      exit();
     2a5:	e8 fa 39 00 00       	call   3ca4 <exit>
  ...
  if(pid < 0){
    ...
    exit();
     2bf:	e8 e0 39 00 00       	call   3ca4 <exit>
    if(mkdir("iputdir") < 0){
      printf(stdout, "mkdir failed\n");
      exit();
    }
    if(chdir("iputdir") < 0){
     ...
     2d4:	e8 27 3b 00 00       	call   3e00 <printf>
      exit();
     2d9:	e8 c6 39 00 00       	call   3ca4 <exit>
    printf(stdout, "fork failed\n");
    exit();
  }
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     2ee:	e8 0d 3b 00 00       	call   3e00 <printf>
      exit();
     2f3:	e8 ac 39 00 00       	call   3ca4 <exit>
     2f8:	90                   	nop
...
openiputtest(void)
{
  ...
  if(mkdir("oidir") < 0){
     ...
     322:	e8 e5 39 00 00       	call   3d0c <mkdir>
  ...
  pid = fork();
     32f:	e8 68 39 00 00       	call   3c9c <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     351:	e8 8e 39 00 00       	call   3ce4 <open>
    if(fd >= 0){
     ...
     36a:	e8 91 3a 00 00       	call   3e00 <printf>
      exit();
     36f:	e8 30 39 00 00       	call   3ca4 <exit>
  ...
  sleep(1);
     ...
     37f:	e8 b0 39 00 00       	call   3d34 <sleep>
  if(unlink("oidir") != 0){
     384:	c7 04 24 07 42 00 00 	movl   $0x4207,(%esp)
     38b:	e8 64 39 00 00       	call   3cf4 <unlink>
  ...
  wait();
     394:	e8 13 39 00 00       	call   3cac <wait>
  ...
  if(unlink("oidir") != 0){
    ...
    exit();
     3c8:	e8 d7 38 00 00       	call   3ca4 <exit>
{
  int pid;
  ...
  if(mkdir("oidir") < 0){
    ...
    exit();
     3e2:	e8 bd 38 00 00       	call   3ca4 <exit>
  }
  pid = fork();
  if(pid < 0){
    printf(stdout, "fork failed\n");
    ...
    exit();
     3fc:	e8 a3 38 00 00       	call   3ca4 <exit>
...
opentest(void)
{
  ...
  fd = open("echo", 0);
     ...
     43a:	e8 a5 38 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  if(fd < 0){
    ...
    exit();
     48f:	e8 10 38 00 00       	call   3ca4 <exit>
  }
  close(fd);
  fd = open("doesnotexist", 0);
  if(fd >= 0){
    ...
    exit();
     4a9:	e8 f6 37 00 00       	call   3ca4 <exit>
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4dc:	e8 03 38 00 00       	call   3ce4 <open>
  if(fd >= 0){
     4e1:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     51b:	e8 a4 37 00 00       	call   3cc4 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     53c:	e8 83 37 00 00       	call   3cc4 <write>
  ...
  i = read(fd, buf, 2000);
     ...
     5b5:	e8 02 37 00 00       	call   3cbc <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     5dd:	e8 ea 36 00 00       	call   3ccc <close>

  if(unlink("small") < 0){
     5e2:	c7 04 24 af 42 00 00 	movl   $0x42af,(%esp)
     5e9:	e8 06 37 00 00       	call   3cf4 <unlink>
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     626:	e8 d5 37 00 00       	call   3e00 <printf>
      exit();
     62b:	e8 74 36 00 00       	call   3ca4 <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10){
      printf(stdout, "error: write bb %d new file failed\n", i);
     ...
     644:	e8 b7 37 00 00       	call   3e00 <printf>
      exit();
     649:	e8 56 36 00 00       	call   3ca4 <exit>
  close(fd);
  fd = open("small", O_RDONLY);
  if(fd >= 0){
    printf(stdout, "open small succeeded ok\n");
    ...
    exit();
     663:	e8 3c 36 00 00       	call   3ca4 <exit>
  }
  i = read(fd, buf, 2000);
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
    ...
    exit();
     67d:	e8 22 36 00 00       	call   3ca4 <exit>
  }
  close(fd);
  ...
  if(unlink("small") < 0){
    ...
    exit();
     697:	e8 08 36 00 00       	call   3ca4 <exit>
  printf(stdout, "small file test\n");
  fd = open("small", O_CREATE|O_RDWR);
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
    ...
    exit();
     6b1:	e8 ee 35 00 00       	call   3ca4 <exit>
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6ec:	e8 f3 35 00 00       	call   3ce4 <open>
  if(fd < 0){
     6f1:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     719:	e8 a6 35 00 00       	call   3cc4 <write>
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     78e:	e8 29 35 00 00       	call   3cbc <read>
    if(i == 0){
  ...
  close(fd);
     ...
     7a6:	e8 21 35 00 00       	call   3ccc <close>
  if(unlink("big") < 0){
     7ab:	c7 04 24 f7 43 00 00 	movl   $0x43f7,(%esp)
     7b2:	e8 3d 35 00 00       	call   3cf4 <unlink>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     7ef:	e8 0c 36 00 00       	call   3e00 <printf>
      exit();
     7f4:	e8 ab 34 00 00       	call   3ca4 <exit>
    } else if(i != 512){
      printf(stdout, "read failed %d\n", i);
      exit();
    }
    if(((int*)buf)[0] != n){
     ...
     811:	e8 ea 35 00 00       	call   3e00 <printf>
             n, ((int*)buf)[0]);
      exit();
     816:	e8 89 34 00 00       	call   3ca4 <exit>
        printf(stdout, "read only %d blocks from big", n);
        exit();
      }
      break;
     ...
     82f:	e8 cc 35 00 00       	call   3e00 <printf>
      exit();
     834:	e8 6b 34 00 00       	call   3ca4 <exit>
  n = 0;
  for(;;){
    i = read(fd, buf, 512);
    if(i == 0){
     ...
     851:	e8 aa 35 00 00       	call   3e00 <printf>
        exit();
     856:	e8 49 34 00 00       	call   3ca4 <exit>
  ...
  if(fd < 0){
    ...
    exit();
     870:	e8 2f 34 00 00       	call   3ca4 <exit>
  ...
  if(fd < 0){
    ...
    exit();
     88a:	e8 15 34 00 00       	call   3ca4 <exit>
    }
    n++;
  }
  close(fd);
  if(unlink("big") < 0){
    ...
    exit();
     8a4:	e8 fb 33 00 00       	call   3ca4 <exit>
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     8f8:	e8 e7 33 00 00       	call   3ce4 <open>
    close(fd);
     8fd:	89 04 24             	mov    %eax,(%esp)
     900:	e8 c7 33 00 00       	call   3ccc <close>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     930:	e8 bf 33 00 00       	call   3cf4 <unlink>
    fd = open(name, O_CREATE|O_RDWR);
    close(fd);
  }
  name[0] = 'a';
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     982:	e8 85 33 00 00       	call   3d0c <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     992:	e8 7d 33 00 00       	call   3d14 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     9a6:	e8 69 33 00 00       	call   3d14 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     9b6:	e8 39 33 00 00       	call   3cf4 <unlink>
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    exit();
     9eb:	e8 b4 32 00 00       	call   3ca4 <exit>
    printf(stdout, "chdir .. failed\n");
    exit();
  }
  ...
  if(unlink("dir0") < 0){
    ...
    exit();
     a05:	e8 9a 32 00 00       	call   3ca4 <exit>
    printf(stdout, "chdir dir0 failed\n");
    exit();
  }
  ...
  if(chdir("..") < 0){
    ...
    exit();
     a1f:	e8 80 32 00 00       	call   3ca4 <exit>
    printf(stdout, "mkdir failed\n");
    exit();
  }
  ...
  if(chdir("dir0") < 0){
    ...
    exit();
     a39:	e8 66 32 00 00       	call   3ca4 <exit>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     a6a:	e8 6d 32 00 00       	call   3cdc <exec>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    ...
    exit();
     a8a:	e8 15 32 00 00       	call   3ca4 <exit>
     a8f:	90                   	nop
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     a9f:	e8 10 32 00 00       	call   3cb4 <pipe>
  ...
  pid = fork();
     aac:	e8 eb 31 00 00       	call   3c9c <fork>
  seq = 0;
  if(pid == 0){
  ...
  seq = 0;
    ...
    close(fds[1]);
     ...
     acd:	e8 fa 31 00 00       	call   3ccc <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aeb:	e8 cc 31 00 00       	call   3cbc <read>
  ...
  if(pid == 0){
    close(fds[0]);
     ...
     b55:	e8 72 31 00 00       	call   3ccc <close>
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     b8e:	e8 31 31 00 00       	call   3cc4 <write>
  ...
  if(pid == 0){
    ...
    if(total != 5 * 1033){
      ...
      exit();
     ba6:	e8 f9 30 00 00       	call   3ca4 <exit>
      total += n;
      cc = cc * 2;
      if(cc > sizeof(buf))
        cc = sizeof(buf);
    ...
    close(fds[0]);
     ...
     bba:	e8 0d 31 00 00       	call   3ccc <close>
    wait();
     bbf:	e8 e8 30 00 00       	call   3cac <wait>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
     ...
     bf8:	eb ac                	jmp    ba6 <pipe1+0x116>
{
  ...
  if(pipe(fds) != 0){
    ...
    exit();
     c0e:	e8 91 30 00 00       	call   3ca4 <exit>
      exit();
    }
    close(fds[0]);
    wait();
    ...
    exit();
     c27:	e8 78 30 00 00       	call   3ca4 <exit>
    close(fds[0]);
    for(n = 0; n < 5; n++){
      for(i = 0; i < 1033; i++)
        buf[i] = seq++;
     ...
     c3b:	e8 c0 31 00 00       	call   3e00 <printf>
        exit();
     c40:	e8 5f 30 00 00       	call   3ca4 <exit>
...
preempt(void)
{
  ...
  pid1 = fork();
     c6d:	e8 2a 30 00 00       	call   3c9c <fork>
  if(pid1 == 0)
     c72:	85 c0                	test   %eax,%eax
{
  ...
  pid2 = fork();
     c80:	e8 17 30 00 00       	call   3c9c <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     c93:	e8 1c 30 00 00       	call   3cb4 <pipe>
  pid3 = fork();
     c98:	e8 ff 2f 00 00       	call   3c9c <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     ca9:	e8 1e 30 00 00       	call   3ccc <close>
    if(write(pfds[1], "x", 1) != 1)
     ...
     cc4:	e8 fb 2f 00 00       	call   3cc4 <write>
    ...
    close(pfds[1]);
     ...
     ce8:	e8 df 2f 00 00       	call   3ccc <close>
  ...
  close(pfds[1]);
     ...
     cf5:	e8 d2 2f 00 00       	call   3ccc <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     d10:	e8 a7 2f 00 00       	call   3cbc <read>
  ...
  close(pfds[0]);
     ...
     d3c:	e8 8b 2f 00 00       	call   3ccc <close>
  printf(1, "kill... ");
  ...
  kill(pid1);
     ...
     d58:	e8 77 2f 00 00       	call   3cd4 <kill>
  kill(pid2);
     d5d:	89 34 24             	mov    %esi,(%esp)
     d60:	e8 6f 2f 00 00       	call   3cd4 <kill>
  kill(pid3);
     d65:	89 1c 24             	mov    %ebx,(%esp)
     d68:	e8 67 2f 00 00       	call   3cd4 <kill>
  printf(1, "wait... ");
  ...
  wait();
     d81:	e8 26 2f 00 00       	call   3cac <wait>
  wait();
     d86:	e8 21 2f 00 00       	call   3cac <wait>
     d8b:	90                   	nop
     d8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  wait();
     d90:	e8 17 2f 00 00       	call   3cac <wait>
  printf(1, "preempt ok\n");
...
exitwait(void)
{
    ...
    if(pid){
     dc0:	74 71                	je     e33 <exitwait+0x83>
      if(wait() != pid){
     dc2:	e8 e5 2e 00 00       	call   3cac <wait>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     dd2:	e8 c5 2e 00 00       	call   3c9c <fork>
    if(pid < 0){
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     e32:	c3                   	ret    
      ...
      exit();
     e33:	e8 6c 2e 00 00       	call   3ca4 <exit>
     e38:	90                   	nop
...
mem(void)
{
  ...
  ppid = getpid();
     e5d:	e8 c2 2e 00 00       	call   3d24 <getpid>
     e62:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     e64:	e8 33 2e 00 00       	call   3c9c <fork>
  ...
  if((pid = fork()) == 0){
    ...
    exit();
     ed4:	e8 cb 2d 00 00       	call   3ca4 <exit>
    ...
    wait();
     ee7:	e9 c0 2d 00 00       	jmp    3cac <wait>
    ...
    if(m1 == 0){
     ...
     f07:	e8 c8 2d 00 00       	call   3cd4 <kill>
      exit();
     f0c:	e8 93 2d 00 00       	call   3ca4 <exit>
...
sharedfd(void)
{
  ...
  pid = fork();
     f67:	e8 30 2d 00 00       	call   3c9c <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fac:	e8 13 2d 00 00       	call   3cc4 <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1022:	e8 95 2c 00 00       	call   3cbc <read>
  ...
  close(fd);
    ...
    1067:	e8 60 2c 00 00       	call   3ccc <close>
  unlink("sharedfd");
    106c:	c7 04 24 a3 45 00 00 	movl   $0x45a3,(%esp)
    1073:	e8 7c 2c 00 00       	call   3cf4 <unlink>
  ...
  if(nc == 10000 && np == 10000){
    ...
    exit();
    10fb:	e8 a4 2b 00 00       	call   3ca4 <exit>
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1143:	e8 ac 2b 00 00       	call   3cf4 <unlink>

    pid = fork();
    1148:	e8 4f 2b 00 00       	call   3c9c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    wait();
    1169:	e8 3e 2b 00 00       	call   3cac <wait>
    116e:	bf 30 00 00 00       	mov    $0x30,%edi
    1173:	e8 34 2b 00 00       	call   3cac <wait>
    1178:	e8 2f 2b 00 00       	call   3cac <wait>
    117d:	e8 2a 2b 00 00       	call   3cac <wait>
  ...
  for(i = 0; i < 2; i++){
    ...
    1199:	e8 46 2b 00 00       	call   3ce4 <open>
    ...
    11b3:	e8 04 2b 00 00       	call   3cbc <read>
  ...
  for(i = 0; i < 2; i++){
    ...
    11d9:	e8 ee 2a 00 00       	call   3ccc <close>
    if(total != 12*500){
    ...
    11f0:	e8 ff 2a 00 00       	call   3cf4 <unlink>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1235:	e8 c6 2b 00 00       	call   3e00 <printf>
          exit();
    123a:	e8 65 2a 00 00       	call   3ca4 <exit>
      printf(1, "fork failed\n");
      exit();
    }
    ...
    1249:	00 
    124a:	e8 95 2a 00 00       	call   3ce4 <open>
      if(fd < 0){
    ...
    1298:	e8 27 2a 00 00       	call   3cc4 <write>
    ...
    12b7:	e8 44 2b 00 00       	call   3e00 <printf>
          exit();
    12bc:	e8 e3 29 00 00       	call   3ca4 <exit>
      }
      total += n;
    }
    close(fd);
    ...
    12d4:	e8 27 2b 00 00       	call   3e00 <printf>
      exit();
    12d9:	e8 c6 29 00 00       	call   3ca4 <exit>
    fname = names[pi];
    unlink(fname);
    ...
    12ed:	e8 0e 2b 00 00       	call   3e00 <printf>
      exit();
    12f2:	e8 ad 29 00 00       	call   3ca4 <exit>
    }
    ...
    1306:	e8 f5 2a 00 00       	call   3e00 <printf>
        exit();
    130b:	e8 94 29 00 00       	call   3ca4 <exit>
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    pid = fork();
    132f:	e8 68 29 00 00       	call   3c9c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    wait();
    1350:	e8 57 29 00 00       	call   3cac <wait>
  }
  ...
  for(pi = 0; pi < 4; pi++){
    wait();
    1357:	e8 50 29 00 00       	call   3cac <wait>
    135c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    135f:	e8 48 29 00 00       	call   3cac <wait>
    1364:	e8 43 29 00 00       	call   3cac <wait>
  }
  ...
  for(i = 0; i < N; i++){
    ...
    13a2:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    13a5:	e8 3a 29 00 00       	call   3ce4 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    13cc:	e8 fb 28 00 00       	call   3ccc <close>
    wait();
  }
  ...
  for(i = 0; i < N; i++){
    ...
    13ff:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    1402:	e8 ed 28 00 00       	call   3cf4 <unlink>
        close(fd);
    }
  }
  ...
  for(i = 0; i < N; i++){
    ...
    148c:	e8 53 28 00 00       	call   3ce4 <open>
        if(fd < 0){
    ...
    1498:	e8 2f 28 00 00       	call   3ccc <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    14b0:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    14b3:	e8 3c 28 00 00       	call   3cf4 <unlink>
    ...
    14cb:	e8 30 29 00 00       	call   3e00 <printf>
            exit();
    14d0:	e8 cf 27 00 00       	call   3ca4 <exit>
    ...
    14eb:	e8 10 29 00 00       	call   3e00 <printf>
        exit();
    14f0:	e8 af 27 00 00       	call   3ca4 <exit>
      name[2] = '\0';
      for(i = 0; i < N; i++){
        name[1] = '0' + i;
        fd = open(name, O_CREATE | O_RDWR);
    ...
    1504:	e8 f7 28 00 00       	call   3e00 <printf>
          exit();
    1509:	e8 96 27 00 00       	call   3ca4 <exit>
  printf(1, "createdelete test\n");
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    151d:	e8 de 28 00 00       	call   3e00 <printf>
      exit();
    1522:	e8 7d 27 00 00       	call   3ca4 <exit>
      fd = open(name, 0);
      if((i == 0 || i >= N/2) && fd < 0){
        printf(1, "oops createdelete %s didn't exist\n", name);
        exit();
    ...
    153a:	e8 c1 28 00 00       	call   3e00 <printf>
        exit();
    153f:	e8 60 27 00 00       	call   3ca4 <exit>
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    157b:	e8 64 27 00 00       	call   3ce4 <open>
  if(fd < 0){
...
unlinkread(void)
{
  ...
  if(unlink("unlinkread") != 0){
    ...
    15cf:	e8 20 27 00 00       	call   3cf4 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15eb:	e8 f4 26 00 00       	call   3ce4 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    ...
    1605:	e8 ba 26 00 00       	call   3cc4 <write>
  close(fd1);
    160a:	89 34 24             	mov    %esi,(%esp)
    160d:	e8 ba 26 00 00       	call   3ccc <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1625:	e8 92 26 00 00       	call   3cbc <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    164f:	e8 70 26 00 00       	call   3cc4 <write>
  ...
  close(fd);
    ...
    165c:	e8 6b 26 00 00       	call   3ccc <close>
  unlink("unlinkread");
    1661:	c7 04 24 55 46 00 00 	movl   $0x4655,(%esp)
    1668:	e8 87 26 00 00       	call   3cf4 <unlink>
  ...
  if(fd < 0){
    ...
    exit();
    169c:	e8 03 26 00 00       	call   3ca4 <exit>
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    exit();
  }
  if(write(fd, buf, 10) != 10){
    ...
    exit();
    16b5:	e8 ea 25 00 00       	call   3ca4 <exit>
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    exit();
  }
  if(buf[0] != 'h'){
    ...
    exit();
    16ce:	e8 d1 25 00 00       	call   3ca4 <exit>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
  write(fd1, "yyy", 3);
  close(fd1);
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    exit();
    16e7:	e8 b8 25 00 00       	call   3ca4 <exit>
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    exit();
  }
  if(unlink("unlinkread") != 0){
    ...
    exit();
    1700:	e8 9f 25 00 00       	call   3ca4 <exit>
  write(fd, "hello", 5);
  close(fd);
  ...
  if(fd < 0){
    ...
    exit();
    1719:	e8 86 25 00 00       	call   3ca4 <exit>
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1784:	e8 3b 25 00 00       	call   3cc4 <write>
  ...
  fd = open("lf2", 0);
    ...
    17ed:	e8 f2 24 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    180f:	e8 a8 24 00 00       	call   3cbc <read>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1874:	e8 8b 24 00 00       	call   3d04 <link>
  ...
  if(fd < 0){
    ...
    exit();
    18ab:	e8 f4 23 00 00       	call   3ca4 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    exit();
  }
  ...
  if(link(".", "lf1") >= 0){
    ...
    exit();
    18c4:	e8 db 23 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    exit();
    18dd:	e8 c2 23 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    exit();
    18f6:	e8 a9 23 00 00       	call   3ca4 <exit>
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    exit();
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    exit();
    190f:	e8 90 23 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(fd < 0){
    ...
    exit();
    1928:	e8 77 23 00 00       	call   3ca4 <exit>
    exit();
  }
  unlink("lf1");
  ...
  if(open("lf1", 0) >= 0){
    ...
    exit();
    1941:	e8 5e 23 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  ...
  if(link("lf1", "lf2") < 0){
    ...
    exit();
    195a:	e8 45 23 00 00       	call   3ca4 <exit>
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    exit();
  }
  if(write(fd, "hello", 5) != 5){
    ...
    exit();
    1973:	e8 2c 23 00 00       	call   3ca4 <exit>
    1978:	90                   	nop
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    19d5:	e8 0a 23 00 00       	call   3ce4 <open>
      if(fd < 0){
    ...
    19e5:	e8 e2 22 00 00       	call   3ccc <close>
    }
    if(pid == 0)
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid == 0)
      ...
      wait();
    19f1:	e8 b6 22 00 00       	call   3cac <wait>
  } de;
  ...
  for(i = 0; i < 40; i++){
    ...
    1a04:	e8 eb 22 00 00       	call   3cf4 <unlink>
    pid = fork();
    1a09:	e8 8e 22 00 00       	call   3c9c <fork>
    if(pid && (i % 3) == 1){
  ...
  for(i = 0; i < 40; i++){
    ...
    1a3b:	e8 c4 22 00 00       	call   3d04 <link>
      continue;
    if(de.name[0] == 'C' && de.name[2] == '\0'){
      ...
      if(i < 0 || i >= sizeof(fa)){
        ...
        exit();
    1a40:	e8 5f 22 00 00       	call   3ca4 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a56:	e8 a9 22 00 00       	call   3d04 <link>
      close(fd);
    }
    if(pid == 0)
      exit();
      ...
      wait();
    1a5b:	e8 4c 22 00 00       	call   3cac <wait>
  } de;
  ...
  fd = open(".", 0);
    ...
    1a95:	e8 4a 22 00 00       	call   3ce4 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ab7:	e8 00 22 00 00       	call   3cbc <read>
  ...
  close(fd);
    ...
    1b03:	e8 c4 21 00 00       	call   3ccc <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid == 0)
      ...
      wait();
    1b8b:	e8 1c 21 00 00       	call   3cac <wait>
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    exit();
  }
  ...
  for(i = 0; i < 40; i++){
    ...
    file[1] = '0' + i;
    pid = fork();
    1b9b:	e8 fc 20 00 00       	call   3c9c <fork>
    if(pid < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    1bd1:	e8 1e 21 00 00       	call   3cf4 <unlink>
      unlink(file);
    1bd6:	89 1c 24             	mov    %ebx,(%esp)
    1bd9:	e8 16 21 00 00       	call   3cf4 <unlink>
      unlink(file);
    1bde:	89 1c 24             	mov    %ebx,(%esp)
    1be1:	e8 0e 21 00 00       	call   3cf4 <unlink>
      unlink(file);
    1be6:	89 1c 24             	mov    %ebx,(%esp)
    1be9:	e8 06 21 00 00       	call   3cf4 <unlink>
  ...
  for(i = 0; i < 40; i++){
    ...
    1c1b:	e8 e0 21 00 00       	call   3e00 <printf>
      exit();
    1c20:	e8 7f 20 00 00       	call   3ca4 <exit>
    } else if(pid == 0 && (i % 5) == 1){
      link("C0", file);
    } else {
      fd = open(file, O_CREATE | O_RDWR);
    ...
    1c38:	e8 c3 21 00 00       	call   3e00 <printf>
        exit();
    1c3d:	e8 62 20 00 00       	call   3ca4 <exit>
    if(de.inum == 0)
      continue;
    if(de.name[0] == 'C' && de.name[2] == '\0'){
      i = de.name[1] - '0';
  ...
  if(n != 40){
    ...
    exit();
    1c76:	e8 29 20 00 00       	call   3ca4 <exit>
      if(i < 0 || i >= sizeof(fa)){
        printf(1, "concreate weird file %s\n", de.name);
        exit();
      }
    ...
    1c91:	e8 6a 21 00 00       	call   3e00 <printf>
        exit();
    1c96:	e8 09 20 00 00       	call   3ca4 <exit>
    1c9b:	90                   	nop
...
linkunlink()
{
  ...
  unlink("x");
    ...
    1cc4:	e8 2b 20 00 00       	call   3cf4 <unlink>
  pid = fork();
    1cc9:	e8 ce 1f 00 00       	call   3c9c <fork>
  if(pid < 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    1d04:	e8 eb 1f 00 00       	call   3cf4 <unlink>
    printf(1, "fork failed\n");
    exit();
  }
  ...
  for(i = 0; i < 100; i++){
    ...
    1d38:	e8 a7 1f 00 00       	call   3ce4 <open>
    1d3d:	89 04 24             	mov    %eax,(%esp)
    1d40:	e8 87 1f 00 00       	call   3ccc <close>
    printf(1, "fork failed\n");
    exit();
  }
  ...
  if(pid)
    1d4a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    1d4d:	85 d2                	test   %edx,%edx
    1d4f:	74 59                	je     1daa <linkunlink+0x10a>
    wait();
    1d51:	e8 56 1f 00 00       	call   3cac <wait>
  else
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d87:	e8 78 1f 00 00       	call   3d04 <link>
  ...
  if(pid < 0){
    ...
    exit();
    1da5:	e8 fa 1e 00 00       	call   3ca4 <exit>
  }
  ...
  if(pid)
    ...
    exit();
    1daa:	e8 f5 1e 00 00       	call   3ca4 <exit>
    1daf:	90                   	nop
...
bigdir(void)
{
  ...
  close(fd);
    1df9:	e8 ce 1e 00 00       	call   3ccc <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
    1e31:	e8 ce 1e 00 00       	call   3d04 <link>
  ...
  unlink("bd");
    1e4f:	e8 a0 1e 00 00       	call   3cf4 <unlink>
  ...
  for(i = 0; i < 500; i++){
    ...
    if(unlink(name) != 0){
    1e79:	e8 76 1e 00 00       	call   3cf4 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1eb7:	e8 44 1f 00 00       	call   3e00 <printf>
      exit();
    1ebc:	e8 e3 1d 00 00       	call   3ca4 <exit>
    name[0] = 'x';
    name[1] = '0' + (i / 64);
    name[2] = '0' + (i % 64);
    name[3] = '\0';
    ...
    1ed0:	e8 2b 1f 00 00       	call   3e00 <printf>
      exit();
    1ed5:	e8 ca 1d 00 00       	call   3ca4 <exit>
  printf(1, "bigdir test\n");
  unlink("bd");
  ...
  if(fd < 0){
    ...
    exit();
    1eee:	e8 b1 1d 00 00       	call   3ca4 <exit>
...
subdir(void)
{
  ...
  unlink("ff");
    ...
    1f22:	e8 cd 1d 00 00       	call   3cf4 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 d8 49 00 00 	movl   $0x49d8,(%esp)
    1f2e:	e8 d9 1d 00 00       	call   3d0c <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f4a:	e8 95 1d 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1f6c:	e8 53 1d 00 00       	call   3cc4 <write>
  close(fd);
    1f71:	89 1c 24             	mov    %ebx,(%esp)
    1f74:	e8 53 1d 00 00       	call   3ccc <close>

  if(unlink("dd") >= 0){
    1f79:	c7 04 24 d8 49 00 00 	movl   $0x49d8,(%esp)
    1f80:	e8 6f 1d 00 00       	call   3cf4 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1f94:	e8 73 1d 00 00       	call   3d0c <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fb0:	e8 2f 1d 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2010:	e8 a7 1c 00 00       	call   3cbc <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2056:	e8 99 1c 00 00       	call   3cf4 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2072:	e8 6d 1c 00 00       	call   3ce4 <open>
  ...
  if(chdir("dd") != 0){
    ...
    2086:	e8 89 1c 00 00       	call   3d14 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    209a:	e8 75 1c 00 00       	call   3d14 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    20ae:	e8 61 1c 00 00       	call   3d14 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    20c2:	e8 4d 1c 00 00       	call   3d14 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20de:	e8 01 1c 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2100:	e8 b7 1b 00 00       	call   3cbc <read>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2141:	e8 9e 1b 00 00       	call   3ce4 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    215d:	e8 82 1b 00 00       	call   3ce4 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2179:	e8 66 1b 00 00       	call   3ce4 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2195:	e8 4a 1b 00 00       	call   3ce4 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    21b1:	e8 2e 1b 00 00       	call   3ce4 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    21cd:	e8 32 1b 00 00       	call   3d04 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    21e9:	e8 16 1b 00 00       	call   3d04 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2205:	e8 fa 1a 00 00       	call   3d04 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2219:	e8 ee 1a 00 00       	call   3d0c <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    222d:	e8 da 1a 00 00       	call   3d0c <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2241:	e8 c6 1a 00 00       	call   3d0c <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2255:	e8 9a 1a 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2269:	e8 86 1a 00 00       	call   3cf4 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    227d:	e8 92 1a 00 00       	call   3d14 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    2291:	e8 7e 1a 00 00       	call   3d14 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    22a5:	e8 4a 1a 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    22b9:	e8 36 1a 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    22cd:	e8 22 1a 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    22e1:	e8 0e 1a 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    22f5:	e8 fa 19 00 00       	call   3cf4 <unlink>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    exit();
    2330:	e8 6f 19 00 00       	call   3ca4 <exit>
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    exit();
  }
  if(chdir("dd/../../dd") != 0){
    ...
    exit();
    2349:	e8 56 19 00 00       	call   3ca4 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    exit();
  }
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    exit();
    2362:	e8 3d 19 00 00       	call   3ca4 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    exit();
  }
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    exit();
    237b:	e8 24 19 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit();
    2394:	e8 0b 19 00 00       	call   3ca4 <exit>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    exit();
  }
  if(mkdir("dd/ff/ff") == 0){
    ...
    exit();
    23ad:	e8 f2 18 00 00       	call   3ca4 <exit>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    exit();
  }
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    exit();
    23c6:	e8 d9 18 00 00       	call   3ca4 <exit>
  write(fd, "FF", 2);
  close(fd);
  ...
  if(fd < 0){
    ...
    exit();
    23df:	e8 c0 18 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(fd < 0){
    ...
    exit();
    23f8:	e8 a7 18 00 00       	call   3ca4 <exit>
  if(chdir("dd/../../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    exit();
  }
  if(chdir("./..") != 0){
    ...
    exit();
    2411:	e8 8e 18 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    exit();
    242a:	e8 75 18 00 00       	call   3ca4 <exit>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    exit();
  }
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    exit();
    2443:	e8 5c 18 00 00       	call   3ca4 <exit>
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    exit();
  }
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    exit();
    245c:	e8 43 18 00 00       	call   3ca4 <exit>
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    exit();
  }
  if(open("dd", O_WRONLY) >= 0){
    ...
    exit();
    2475:	e8 2a 18 00 00       	call   3ca4 <exit>
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    exit();
  }
  if(open("dd", O_RDWR) >= 0){
    ...
    exit();
    248e:	e8 11 18 00 00       	call   3ca4 <exit>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    exit();
  }
  if(open("dd", O_CREATE) >= 0){
    ...
    exit();
    24a7:	e8 f8 17 00 00       	call   3ca4 <exit>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    exit();
  }
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    exit();
    24c0:	e8 df 17 00 00       	call   3ca4 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    exit();
  }
  ...
  if(chdir("dd") != 0){
    ...
    exit();
    24d9:	e8 c6 17 00 00       	call   3ca4 <exit>
  if(unlink("dd/dd/ff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    exit();
  }
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit();
    24f2:	e8 ad 17 00 00       	call   3ca4 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    exit();
  }
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    exit();
    250b:	e8 94 17 00 00       	call   3ca4 <exit>
  }
  write(fd, "ff", 2);
  close(fd);
  ...
  if(unlink("dd") >= 0){
    ...
    exit();
    2524:	e8 7b 17 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(fd < 0){
    ...
    exit();
    253d:	e8 62 17 00 00       	call   3ca4 <exit>
  ...
  if(mkdir("dd") != 0){
    ...
    exit();
    2556:	e8 49 17 00 00       	call   3ca4 <exit>
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    exit();
  }
  if(unlink("dd") < 0){
    ...
    exit();
    256f:	e8 30 17 00 00       	call   3ca4 <exit>
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    exit();
  }
  if(unlink("dd/dd") < 0){
    ...
    exit();
    2588:	e8 17 17 00 00       	call   3ca4 <exit>
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    exit();
  }
  if(unlink("dd") == 0){
    ...
    exit();
    25a1:	e8 fe 16 00 00       	call   3ca4 <exit>
  if(unlink("dd/dd/ffff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    exit();
  }
  if(unlink("dd/ff") != 0){
    ...
    exit();
    25ba:	e8 e5 16 00 00       	call   3ca4 <exit>
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    exit();
  }
  if(chdir("dd/xx") == 0){
    ...
    exit();
    25d3:	e8 cc 16 00 00       	call   3ca4 <exit>
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    exit();
  }
  if(chdir("dd/ff") == 0){
    ...
    exit();
    25ec:	e8 b3 16 00 00       	call   3ca4 <exit>
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    exit();
  }
  if(unlink("dd/ff/ff") == 0){
    ...
    exit();
    2605:	e8 9a 16 00 00       	call   3ca4 <exit>
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    exit();
  }
  if(unlink("dd/xx/ff") == 0){
    ...
    exit();
    261e:	e8 81 16 00 00       	call   3ca4 <exit>
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    exit();
  }
  if(mkdir("dd/dd/ffff") == 0){
    ...
    exit();
    2637:	e8 68 16 00 00       	call   3ca4 <exit>
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    exit();
  }
  if(mkdir("dd/xx/ff") == 0){
    ...
    exit();
    2650:	e8 4f 16 00 00       	call   3ca4 <exit>
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    exit();
  }
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    exit();
    2669:	e8 36 16 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(fd < 0){
    ...
    exit();
    2682:	e8 1d 16 00 00       	call   3ca4 <exit>
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    26b8:	e8 37 16 00 00       	call   3cf4 <unlink>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26cf:	e8 10 16 00 00       	call   3ce4 <open>
    if(fd < 0){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26ed:	e8 d2 15 00 00       	call   3cc4 <write>
      if(cc != sz){
    ...
    2705:	e8 ba 15 00 00       	call   3cc4 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2717:	e8 b0 15 00 00       	call   3ccc <close>
    unlink("bigwrite");
    271c:	c7 04 24 d4 4b 00 00 	movl   $0x4bd4,(%esp)
    2723:	e8 cc 15 00 00       	call   3cf4 <unlink>
  int fd, sz;
  ...
  printf(1, "bigwrite ok\n");
    ...
    2762:	e8 99 16 00 00       	call   3e00 <printf>
        exit();
    2767:	e8 38 15 00 00       	call   3ca4 <exit>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    277b:	e8 80 16 00 00       	call   3e00 <printf>
      exit();
    2780:	e8 1f 15 00 00       	call   3ca4 <exit>
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    280b:	e8 b4 14 00 00       	call   3cc4 <write>
  ...
  for(i = 0; ; i++){
    ...
    2891:	e8 26 14 00 00       	call   3cbc <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    289f:	90                   	nop
    28a0:	e8 27 14 00 00       	call   3ccc <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    28b8:	e8 37 14 00 00       	call   3cf4 <unlink>
  ...
  printf(1, "bigfile test ok\n");
    ...
    28e8:	e8 13 15 00 00       	call   3e00 <printf>
      exit();
    28ed:	e8 b2 13 00 00       	call   3ca4 <exit>
      exit();
    }
    if(cc == 0)
      break;
    ...
    2901:	e8 fa 14 00 00       	call   3e00 <printf>
      exit();
    2906:	e8 99 13 00 00       	call   3ca4 <exit>
  }
  total = 0;
  for(i = 0; ; i++){
    cc = read(fd, buf, 300);
    ...
    291a:	e8 e1 14 00 00       	call   3e00 <printf>
      exit();
    291f:	e8 80 13 00 00       	call   3ca4 <exit>
    exit();
  }
  for(i = 0; i < 20; i++){
    memset(buf, i, 600);
    ...
    2933:	e8 c8 14 00 00       	call   3e00 <printf>
      exit();
    2938:	e8 67 13 00 00       	call   3ca4 <exit>
  }
  close(fd);
  ...
  if(fd < 0){
    ...
    exit();
    2951:	e8 4e 13 00 00       	call   3ca4 <exit>
  printf(1, "bigfile test\n");
  ...
  if(fd < 0){
    ...
    exit();
    296a:	e8 35 13 00 00       	call   3ca4 <exit>
    }
    total += cc;
  }
  close(fd);
  if(total != 20*600){
    ...
    exit();
    2983:	e8 1c 13 00 00       	call   3ca4 <exit>
    2988:	90                   	nop
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    29b1:	e8 56 13 00 00       	call   3d0c <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    29c5:	e8 42 13 00 00       	call   3d0c <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29e1:	e8 fe 12 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2a15:	e8 b2 12 00 00       	call   3ccc <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2a1a:	c7 04 24 fc 4c 00 00 	movl   $0x4cfc,(%esp)
    2a21:	e8 e6 12 00 00       	call   3d0c <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2a31:	e8 d6 12 00 00       	call   3d0c <mkdir>
  ...
  if(mkdir("12345678901234") != 0){
    ...
    exit();
    2a64:	e8 3b 12 00 00       	call   3ca4 <exit>
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    exit();
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    exit();
    2a7d:	e8 22 12 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    exit();
    2a96:	e8 09 12 00 00       	call   3ca4 <exit>
    exit();
  }
  close(fd);
  fd = open("12345678901234/12345678901234/12345678901234", 0);
  if(fd < 0){
    ...
    exit();
    2aaf:	e8 f0 11 00 00       	call   3ca4 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    exit();
  }
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
  if(fd < 0){
    ...
    exit();
    2ac8:	e8 d7 11 00 00       	call   3ca4 <exit>
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
    exit();
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    exit();
    2ae1:	e8 be 11 00 00       	call   3ca4 <exit>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2b11:	e8 f6 11 00 00       	call   3d0c <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2b25:	e8 ea 11 00 00       	call   3d14 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2b39:	e8 b6 11 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2b4d:	e8 a2 11 00 00       	call   3cf4 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2b61:	e8 ae 11 00 00       	call   3d14 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2b75:	e8 7a 11 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2b89:	e8 66 11 00 00       	call   3cf4 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2b99:	e8 56 11 00 00       	call   3cf4 <unlink>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    exit();
    2bcc:	e8 d3 10 00 00       	call   3ca4 <exit>
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
    exit();
  }
  if(unlink("dots") != 0){
    ...
    exit();
    2be5:	e8 ba 10 00 00       	call   3ca4 <exit>
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
    exit();
  }
  if(unlink("dots/..") == 0){
    ...
    exit();
    2bfe:	e8 a1 10 00 00       	call   3ca4 <exit>
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
    exit();
  }
  if(unlink("dots/.") == 0){
    ...
    exit();
    2c17:	e8 88 10 00 00       	call   3ca4 <exit>
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
    exit();
  }
  if(chdir("/") != 0){
    ...
    exit();
    2c30:	e8 6f 10 00 00       	call   3ca4 <exit>
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
    exit();
  }
  if(unlink("..") == 0){
    ...
    exit();
    2c49:	e8 56 10 00 00       	call   3ca4 <exit>
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
    exit();
  }
  if(unlink(".") == 0){
    ...
    exit();
    2c62:	e8 3d 10 00 00       	call   3ca4 <exit>
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
    exit();
  }
  if(chdir("dots") != 0){
    ...
    exit();
    2c7b:	e8 24 10 00 00       	call   3ca4 <exit>
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2caa:	e8 35 10 00 00       	call   3ce4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2cba:	e8 0d 10 00 00       	call   3ccc <close>
  if(chdir("dirfile") == 0){
    2cbf:	c7 04 24 e5 4d 00 00 	movl   $0x4de5,(%esp)
    2cc6:	e8 49 10 00 00       	call   3d14 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce2:	e8 fd 0f 00 00       	call   3ce4 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2cfe:	e8 e1 0f 00 00       	call   3ce4 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2d12:	e8 f5 0f 00 00       	call   3d0c <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2d26:	e8 c9 0f 00 00       	call   3cf4 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2d42:	e8 bd 0f 00 00       	call   3d04 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2d56:	e8 99 0f 00 00       	call   3cf4 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2d72:	e8 6d 0f 00 00       	call   3ce4 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2d8e:	e8 51 0f 00 00       	call   3ce4 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    2da8:	e8 17 0f 00 00       	call   3cc4 <write>
  ...
  close(fd);
    ...
    2db4:	e8 13 0f 00 00       	call   3ccc <close>
  ...
  if(fd >= 0){
    ...
    exit();
    2de7:	e8 b8 0e 00 00       	call   3ca4 <exit>
    printf(1, "create dirfile failed\n");
    exit();
  }
  close(fd);
  if(chdir("dirfile") == 0){
    ...
    exit();
    2e00:	e8 9f 0e 00 00       	call   3ca4 <exit>
  ...
  if(fd < 0){
    ...
    exit();
    2e19:	e8 86 0e 00 00       	call   3ca4 <exit>
    printf(1, "open . for writing succeeded!\n");
    exit();
  }
  fd = open(".", 0);
  if(write(fd, "x", 1) > 0){
    ...
    exit();
    2e32:	e8 6d 0e 00 00       	call   3ca4 <exit>
    exit();
  }
  ...
  if(fd >= 0){
    ...
    exit();
    2e4b:	e8 54 0e 00 00       	call   3ca4 <exit>
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
    exit();
  }
  if(unlink("dirfile") != 0){
    ...
    exit();
    2e64:	e8 3b 0e 00 00       	call   3ca4 <exit>
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
    exit();
  }
  if(link("README", "dirfile/xx") == 0){
    ...
    exit();
    2e7d:	e8 22 0e 00 00       	call   3ca4 <exit>
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
    exit();
  }
  if(unlink("dirfile/xx") == 0){
    ...
    exit();
    2e96:	e8 09 0e 00 00       	call   3ca4 <exit>
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
    exit();
  }
  if(mkdir("dirfile/xx") == 0){
    ...
    exit();
    2eaf:	e8 f0 0d 00 00       	call   3ca4 <exit>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2ee7:	e8 20 0e 00 00       	call   3d0c <mkdir>
    ...
    2efb:	e8 14 0e 00 00       	call   3d14 <chdir>
  ...
  chdir("/");
    ...
    2f84:	e8 8b 0d 00 00       	call   3d14 <chdir>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb2:	e8 49 0e 00 00       	call   3e00 <printf>
      exit();
    2fb7:	e8 e8 0c 00 00       	call   3ca4 <exit>
    }
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
    ...
    2fcb:	e8 30 0e 00 00       	call   3e00 <printf>
      exit();
    2fd0:	e8 cf 0c 00 00       	call   3ca4 <exit>
    ...
    3000:	0f 84 87 00 00 00    	je     308d <forktest+0xad>
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    3012:	e8 85 0c 00 00       	call   3c9c <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    3028:	e8 7f 0c 00 00       	call   3cac <wait>
  ...
  if(wait() != -1){
    3037:	e8 70 0c 00 00       	call   3cac <wait>
  ...
  if(n == 1000){
    ...
    exit();
    3074:	e8 2b 0c 00 00       	call   3ca4 <exit>
  }
  ...
  for(; n > 0; n--){
    ...
    3088:	e8 73 0d 00 00       	call   3e00 <printf>
      exit();
    308d:	e8 12 0c 00 00       	call   3ca4 <exit>
    }
  }
  ...
  if(wait() != -1){
    ...
    exit();
    30a6:	e8 f9 0b 00 00       	call   3ca4 <exit>
    30ab:	90                   	nop
...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    30d7:	e8 50 0c 00 00       	call   3d2c <sbrk>
  ...
  // can one sbrk() less than a page?
  a = sbrk(0);
    30e6:	e8 41 0c 00 00       	call   3d2c <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    30f7:	e8 30 0c 00 00       	call   3d2c <sbrk>
    if(b != a){
  ...
  pid = fork();
    3118:	e8 7f 0b 00 00       	call   3c9c <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    312e:	e8 f9 0b 00 00       	call   3d2c <sbrk>
  c = sbrk(1);
    3133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    313a:	e8 ed 0b 00 00       	call   3d2c <sbrk>
  if(c != a + 1){
  ...
  if(pid == 0)
    ...
    exit();
  wait();
    3152:	e8 55 0b 00 00       	call   3cac <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    3157:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    315e:	e8 c9 0b 00 00       	call   3d2c <sbrk>
  amt = (BIG) - (uint)a;
...
#define BIG (100*1024*1024)
  ...
  p = sbrk(amt);
    ...
    316f:	e8 b8 0b 00 00       	call   3d2c <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    318a:	e8 9d 0b 00 00       	call   3d2c <sbrk>
  c = sbrk(-4096);
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-4096);
    3198:	e8 8f 0b 00 00       	call   3d2c <sbrk>
  ...
  c = sbrk(0);
    ...
    31ad:	e8 7a 0b 00 00       	call   3d2c <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    31c7:	e8 60 0b 00 00       	call   3d2c <sbrk>
  c = sbrk(4096);
  ...
  c = sbrk(4096);
    31d5:	e8 52 0b 00 00       	call   3d2c <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    31eb:	e8 3c 0b 00 00       	call   3d2c <sbrk>
  ...
  a = sbrk(0);
    ...
    3212:	e8 15 0b 00 00       	call   3d2c <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ppid = getpid();
    3240:	e8 df 0a 00 00       	call   3d24 <getpid>
    3245:	89 c6                	mov    %eax,%esi
    pid = fork();
    3247:	e8 50 0a 00 00       	call   3c9c <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    3260:	e8 47 0a 00 00       	call   3cac <wait>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    exit();
  }
  ...
  if(pipe(fds) != 0){
    ...
    3273:	e8 3c 0a 00 00       	call   3cb4 <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    if((pids[i] = fork()) == 0){
    3289:	e8 0e 0a 00 00       	call   3c9c <fork>
    ...
    32af:	e8 08 0a 00 00       	call   3cbc <read>
  ...
  c = sbrk(4096);
    ...
    32c5:	e8 62 0a 00 00       	call   3d2c <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    32d6:	e8 f9 09 00 00       	call   3cd4 <kill>
    wait();
    32db:	e8 cc 09 00 00       	call   3cac <wait>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3368:	e8 57 09 00 00       	call   3cc4 <write>
    336d:	8d 76 00             	lea    0x0(%esi),%esi
      // sit around until killed
      for(;;) sleep(1000);
    3370:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
    3377:	e8 b8 09 00 00       	call   3d34 <sleep>
  ...
  for(i = 0; i < 5000; i++){
    ...
    339a:	e8 61 0a 00 00       	call   3e00 <printf>
      exit();
    339f:	e8 00 09 00 00       	call   3ca4 <exit>
      continue;
    kill(pids[i]);
    wait();
  }
  if(c == (char*)0xffffffff){
    ...
    exit();
    33b9:	e8 e6 08 00 00       	call   3ca4 <exit>
  }
  ...
  if(pipe(fds) != 0){
    ...
    exit();
    33d2:	e8 cd 08 00 00       	call   3ca4 <exit>
    if(pid < 0){
      printf(stdout, "fork failed\n");
      exit();
    }
    ...
    33fa:	e8 d5 08 00 00       	call   3cd4 <kill>
      exit();
    33ff:	e8 a0 08 00 00       	call   3ca4 <exit>
  // can we read the kernel's memory?
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ppid = getpid();
    pid = fork();
    ...
    3414:	e8 e7 09 00 00       	call   3e00 <printf>
      exit();
    3419:	e8 86 08 00 00       	call   3ca4 <exit>
  }
  ...
  if(c != a){
    ...
    exit();
    343b:	e8 64 08 00 00       	call   3ca4 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    exit();
  }
  if(*lastaddr == 99){
    ...
    exit();
    3455:	e8 4a 08 00 00       	call   3ca4 <exit>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    exit();
    3477:	e8 28 08 00 00       	call   3ca4 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    exit();
  }
  c = sbrk(0);
  if(c != a - 4096){
    ...
    exit();
    3499:	e8 06 08 00 00       	call   3ca4 <exit>
  ...
  if(c == (char*)0xffffffff){
    ...
    exit();
    34b3:	e8 ec 07 00 00       	call   3ca4 <exit>
#define BIG (100*1024*1024)
  a = sbrk(0);
  amt = (BIG) - (uint)a;
  p = sbrk(amt);
  if (p != a) {
    ...
    exit();
    34cd:	e8 d2 07 00 00       	call   3ca4 <exit>
    exit();
  }
  c = sbrk(1);
  c = sbrk(1);
  if(c != a + 1){
    ...
    exit();
    34e7:	e8 b8 07 00 00       	call   3ca4 <exit>
    *b = 1;
    a = b + 1;
  }
  pid = fork();
  if(pid < 0){
    ...
    exit();
    3501:	e8 9e 07 00 00       	call   3ca4 <exit>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    if((pid = fork()) == 0){
    3540:	e8 57 07 00 00       	call   3c9c <fork>
    ...
    3552:	e8 dd 07 00 00       	call   3d34 <sleep>
    sleep(0);
    3557:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    355e:	e8 d1 07 00 00       	call   3d34 <sleep>
    kill(pid);
    3563:	89 34 24             	mov    %esi,(%esp)
    3566:	e8 69 07 00 00       	call   3cd4 <kill>
    wait();
    356b:	e8 3c 07 00 00       	call   3cac <wait>

    // try to crash the kernel by passing in a bad string pointer
    if(link("nosuchfile", (char*)p) != -1){
    3570:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    3574:	c7 04 24 1d 50 00 00 	movl   $0x501d,(%esp)
    357b:	e8 84 07 00 00       	call   3d04 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    35bf:	e8 3c 08 00 00       	call   3e00 <printf>
      exit();
    35c4:	e8 db 06 00 00       	call   3ca4 <exit>
...
bsstest(void)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    363a:	e8 c1 07 00 00       	call   3e00 <printf>
      exit();
    363f:	e8 60 06 00 00       	call   3ca4 <exit>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    365d:	e8 92 06 00 00       	call   3cf4 <unlink>
  pid = fork();
    3662:	e8 35 06 00 00       	call   3c9c <fork>
  if(pid == 0){
  ...
  close(fd);
    ...
    369a:	e8 2d 06 00 00       	call   3ccc <close>
  unlink("bigarg-ok");
    369f:	c7 04 24 76 50 00 00 	movl   $0x5076,(%esp)
    36a6:	e8 49 06 00 00       	call   3cf4 <unlink>
}
    36ab:	c9                   	leave  
    36ac:	c3                   	ret    
  ...
  if(pid == 0){
    ...
    36f1:	e8 e6 05 00 00       	call   3cdc <exec>
    printf(stdout, "bigarg test ok\n");
    ...
    371a:	e8 c5 05 00 00       	call   3ce4 <open>
    close(fd);
    371f:	89 04 24             	mov    %eax,(%esp)
    3722:	e8 a5 05 00 00       	call   3ccc <close>
    exit();
    3727:	e8 78 05 00 00       	call   3ca4 <exit>
    exit();
  }
  wait();
  fd = open("bigarg-ok", 0);
  if(fd < 0){
    ...
    exit();
    3741:	e8 5e 05 00 00       	call   3ca4 <exit>
    printf(stdout, "bigarg test ok\n");
    fd = open("bigarg-ok", O_CREATE);
    close(fd);
    exit();
    ...
    exit();
    375b:	e8 44 05 00 00       	call   3ca4 <exit>
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    382b:	e8 b4 04 00 00       	call   3ce4 <open>
    if(fd < 0){
    ...
    3855:	e8 6a 04 00 00       	call   3cc4 <write>
      if(cc < 512)
    ...
    387c:	e8 4b 04 00 00       	call   3ccc <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3933:	e8 bc 03 00 00       	call   3cf4 <unlink>
    close(fd);
    if(total == 0)
      break;
  }
...
uio()
{
  ...
  pid = fork();
    397a:	e8 1d 03 00 00       	call   3c9c <fork>
  if(pid == 0){
  ...
  wait();
    3985:	e8 22 03 00 00       	call   3cac <wait>
  ...
  if(pid == 0){
    ...
    exit();
    39c2:	e8 dd 02 00 00       	call   3ca4 <exit>
  } else if(pid < 0){
    printf (1, "fork failed\n");
    ...
    exit();
    39db:	e8 c4 02 00 00       	call   3ca4 <exit>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39f6:	e8 e9 02 00 00       	call   3ce4 <open>
  if (fd < 0) {
...
void argptest()
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3a08:	e8 1f 03 00 00       	call   3d2c <sbrk>
    ...
    3a1f:	e8 98 02 00 00       	call   3cbc <read>
  close(fd);
    3a24:	89 1c 24             	mov    %ebx,(%esp)
    3a27:	e8 a0 02 00 00       	call   3ccc <close>
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    exit();
    3a5a:	e8 45 02 00 00       	call   3ca4 <exit>
    3a5f:	90                   	nop
...
00003b90 <gets>:
    ...
    3bb3:	e8 04 01 00 00       	call   3cbc <read>
...
00003bf0 <stat>:
    ...
    3c06:	e8 d9 00 00 00       	call   3ce4 <open>
    ...
    3c1b:	e8 dc 00 00 00       	call   3cfc <fstat>
    3c20:	89 1c 24             	mov    %ebx,(%esp)
    3c23:	89 c6                	mov    %eax,%esi
    3c25:	e8 a2 00 00 00       	call   3ccc <close>
...
SYSCALL(fork)
    3c9c:	b8 01 00 00 00       	mov    $0x1,%eax
    3ca1:	cd 40                	int    $0x40
    3ca3:	c3                   	ret    

00003ca4 <exit>:
SYSCALL(exit)
    3ca4:	b8 02 00 00 00       	mov    $0x2,%eax
    3ca9:	cd 40                	int    $0x40
    3cab:	c3                   	ret    

00003cac <wait>:
SYSCALL(wait)
    3cac:	b8 03 00 00 00       	mov    $0x3,%eax
    3cb1:	cd 40                	int    $0x40
    3cb3:	c3                   	ret    

00003cb4 <pipe>:
SYSCALL(pipe)
    3cb4:	b8 04 00 00 00       	mov    $0x4,%eax
    3cb9:	cd 40                	int    $0x40
    3cbb:	c3                   	ret    

00003cbc <read>:
SYSCALL(read)
    3cbc:	b8 05 00 00 00       	mov    $0x5,%eax
    3cc1:	cd 40                	int    $0x40
    3cc3:	c3                   	ret    

00003cc4 <write>:
SYSCALL(write)
    3cc4:	b8 10 00 00 00       	mov    $0x10,%eax
    3cc9:	cd 40                	int    $0x40
    3ccb:	c3                   	ret    

00003ccc <close>:
SYSCALL(close)
    3ccc:	b8 15 00 00 00       	mov    $0x15,%eax
    3cd1:	cd 40                	int    $0x40
    3cd3:	c3                   	ret    

00003cd4 <kill>:
SYSCALL(kill)
    3cd4:	b8 06 00 00 00       	mov    $0x6,%eax
    3cd9:	cd 40                	int    $0x40
    3cdb:	c3                   	ret    

00003cdc <exec>:
SYSCALL(exec)
    3cdc:	b8 07 00 00 00       	mov    $0x7,%eax
    3ce1:	cd 40                	int    $0x40
    3ce3:	c3                   	ret    

00003ce4 <open>:
SYSCALL(open)
    3ce4:	b8 0f 00 00 00       	mov    $0xf,%eax
    3ce9:	cd 40                	int    $0x40
    3ceb:	c3                   	ret    

00003cec <mknod>:
SYSCALL(mknod)
    3cec:	b8 11 00 00 00       	mov    $0x11,%eax
    3cf1:	cd 40                	int    $0x40
    3cf3:	c3                   	ret    

00003cf4 <unlink>:
SYSCALL(unlink)
    3cf4:	b8 12 00 00 00       	mov    $0x12,%eax
    3cf9:	cd 40                	int    $0x40
    3cfb:	c3                   	ret    

00003cfc <fstat>:
SYSCALL(fstat)
    3cfc:	b8 08 00 00 00       	mov    $0x8,%eax
    3d01:	cd 40                	int    $0x40
    3d03:	c3                   	ret    

00003d04 <link>:
SYSCALL(link)
    3d04:	b8 13 00 00 00       	mov    $0x13,%eax
    3d09:	cd 40                	int    $0x40
    3d0b:	c3                   	ret    

00003d0c <mkdir>:
SYSCALL(mkdir)
    3d0c:	b8 14 00 00 00       	mov    $0x14,%eax
    3d11:	cd 40                	int    $0x40
    3d13:	c3                   	ret    

00003d14 <chdir>:
SYSCALL(chdir)
    3d14:	b8 09 00 00 00       	mov    $0x9,%eax
    3d19:	cd 40                	int    $0x40
    3d1b:	c3                   	ret    

00003d1c <dup>:
SYSCALL(dup)
    3d1c:	b8 0a 00 00 00       	mov    $0xa,%eax
    3d21:	cd 40                	int    $0x40
    3d23:	c3                   	ret    

00003d24 <getpid>:
SYSCALL(getpid)
    3d24:	b8 0b 00 00 00       	mov    $0xb,%eax
    3d29:	cd 40                	int    $0x40
    3d2b:	c3                   	ret    

00003d2c <sbrk>:
SYSCALL(sbrk)
    3d2c:	b8 0c 00 00 00       	mov    $0xc,%eax
    3d31:	cd 40                	int    $0x40
    3d33:	c3                   	ret    

00003d34 <sleep>:
SYSCALL(sleep)
    3d34:	b8 0d 00 00 00       	mov    $0xd,%eax
    3d39:	cd 40                	int    $0x40
    3d3b:	c3                   	ret    

00003d3c <uptime>:
SYSCALL(uptime)
    3d3c:	b8 0e 00 00 00       	mov    $0xe,%eax
    3d41:	cd 40                	int    $0x40
    3d43:	c3                   	ret    

00003d44 <date>:
SYSCALL(date)
    3d44:	b8 16 00 00 00       	mov    $0x16,%eax
    3d49:	cd 40                	int    $0x40
    3d4b:	c3                   	ret    
...
00003d60 <printint>:
    ...
    3dda:	e8 e5 fe ff ff       	call   3cc4 <write>
...
00003e00 <printf>:
    ...
    3e46:	e8 79 fe ff ff       	call   3cc4 <write>
    ...
    3eb6:	e8 09 fe ff ff       	call   3cc4 <write>
    ...
    3ed3:	e8 ec fd ff ff       	call   3cc4 <write>
    ...
    3f60:	e8 5f fd ff ff       	call   3cc4 <write>
    ...
    3f90:	e8 2f fd ff ff       	call   3cc4 <write>
    ...
    3fe0:	e8 df fc ff ff       	call   3cc4 <write>
...
00004080 <malloc>:
    ...
    40ea:	e8 3d fc ff ff       	call   3d2c <sbrk>
