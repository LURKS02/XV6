...
main(int argc, char *argv[])
{
  ...
  1f:	39 f3                	cmp    %esi,%ebx
  21:	74 30                	je     53 <main+0x53>
  23:	90                   	nop
  24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  28:	c7 44 24 0c ee 06 00 	movl   $0x6ee,0xc(%esp)
  2f:	00 
  30:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  34:	83 c3 01             	add    $0x1,%ebx
  37:	c7 44 24 04 f0 06 00 	movl   $0x6f0,0x4(%esp)
  3e:	00 
  3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  46:	89 44 24 08          	mov    %eax,0x8(%esp)
  4a:	e8 c1 03 00 00       	call   410 <printf>
  4f:	39 f3                	cmp    %esi,%ebx
  51:	75 d5                	jne    28 <main+0x28>
  53:	c7 44 24 0c f5 06 00 	movl   $0x6f5,0xc(%esp)
  5a:	00 
  5b:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  5f:	c7 44 24 04 f0 06 00 	movl   $0x6f0,0x4(%esp)
  66:	00 
  67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6e:	89 44 24 08          	mov    %eax,0x8(%esp)
  72:	e8 99 03 00 00       	call   410 <printf>
  exit();
  77:	e8 38 02 00 00       	call   2b4 <exit>
  7c:	90                   	nop
  7d:	90                   	nop
  7e:	90                   	nop
  7f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	f7 f1                	div    %ecx
 3be:	0f b6 92 fe 06 00 00 	movzbl 0x6fe(%edx),%edx
  }while((x /= base) != 0);
 ...
 427:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4f0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 4f3:	b8 f7 06 00 00       	mov    $0x6f7,%eax
...
free(void *ap)
{
 ...
 571:	a1 ac 09 00 00       	mov    0x9ac,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5bf:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c1:	a3 ac 09 00 00       	mov    %eax,0x9ac
}
 5c6:	5b                   	pop    %ebx
 5c7:	5e                   	pop    %esi
 5c8:	5f                   	pop    %edi
 ...
 5e2:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5e5:	a3 ac 09 00 00       	mov    %eax,0x9ac
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 609:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 60c:	8b 15 ac 09 00 00    	mov    0x9ac,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 647:	76 57                	jbe    6a0 <malloc+0xa0>
    ...
    if(p == freep)
 649:	3b 05 ac 09 00 00    	cmp    0x9ac,%eax
...
morecore(uint nu)
{
 ...
 66a:	e8 cd fc ff ff       	call   33c <sbrk>
  if(p == (char*)-1)
 ...
 67d:	e8 ee fe ff ff       	call   570 <free>
  return freep;
 682:	8b 15 ac 09 00 00    	mov    0x9ac,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ac:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6af:	89 15 ac 09 00 00    	mov    %edx,0x9ac
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
        return 0;
 ...
 6c4:	eb e9                	jmp    6af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6c6:	c7 05 ac 09 00 00 b0 	movl   $0x9b0,0x9ac
 6cd:	09 00 00 
    base.s.size = 0;
 6d0:	b8 b0 09 00 00       	mov    $0x9b0,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6d5:	c7 05 b0 09 00 00 b0 	movl   $0x9b0,0x9b0
 6dc:	09 00 00 
    base.s.size = 0;
 6df:	c7 05 b4 09 00 00 00 	movl   $0x0,0x9b4
 6e6:	00 00 00 
