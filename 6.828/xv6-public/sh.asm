      ...
      13:	0f 8f cd 00 00 00    	jg     e6 <main+0xe6>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      28:	e8 f7 0d 00 00       	call   e24 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(fork1() == 0)
      ...
      runcmd(parsecmd(buf));
    wait();
      51:	e8 96 0d 00 00       	call   dec <wait>
      break;
    }
  }
  ...
  exit();
      9d:	e8 42 0d 00 00       	call   de4 <exit>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      if(chdir(buf+3) < 0)
      bc:	e8 93 0d 00 00       	call   e54 <chdir>
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    if(fd >= 3){
      ...
      e9:	e8 1e 0d 00 00       	call   e0c <close>
      ee:	66 90                	xchg   %ax,%ax
      break;
...
panic(char *s)
{
  ...
  exit();
     181:	e8 5e 0c 00 00       	call   de4 <exit>
...
fork1(void)
{
  ...
  pid = fork();
     196:	e8 41 0c 00 00       	call   ddc <fork>
  if(pid == -1)
...
runcmd(struct cmd *cmd)
{
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     1d6:	e8 19 0c 00 00       	call   df4 <pipe>
    ...
    close(p[0]);
     ...
     203:	e8 04 0c 00 00       	call   e0c <close>
    close(p[1]);
     208:	8b 45 f4             	mov    -0xc(%ebp),%eax
     20b:	89 04 24             	mov    %eax,(%esp)
     20e:	e8 f9 0b 00 00       	call   e0c <close>
    wait();
     213:	e8 d4 0b 00 00       	call   dec <wait>
    wait();
     218:	e8 cf 0b 00 00       	call   dec <wait>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      exit();
     220:	e8 bf 0b 00 00       	call   de4 <exit>
    wait();
    break;
  ...
  case EXEC:
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     243:	e8 d4 0b 00 00       	call   e1c <exec>
  ...
  case LIST:
    ...
    if(fork1() == 0)
     ...
     270:	74 31                	je     2a3 <runcmd+0xf3>
      runcmd(lcmd->left);
    wait();
     272:	e8 75 0b 00 00       	call   dec <wait>
    runcmd(lcmd->right);
...
00000cd0 <gets>:
     ...
     cf3:	e8 04 01 00 00       	call   dfc <read>
...
00000d30 <stat>:
     ...
     d46:	e8 d9 00 00 00       	call   e24 <open>
     ...
     d5b:	e8 dc 00 00 00       	call   e3c <fstat>
     d60:	89 1c 24             	mov    %ebx,(%esp)
     d63:	89 c6                	mov    %eax,%esi
     d65:	e8 a2 00 00 00       	call   e0c <close>
...
00000ea0 <printint>:
     ...
     f1a:	e8 e5 fe ff ff       	call   e04 <write>
...
00000f40 <printf>:
     ...
     f86:	e8 79 fe ff ff       	call   e04 <write>
     ...
     ff6:	e8 09 fe ff ff       	call   e04 <write>
    ...
    1013:	e8 ec fd ff ff       	call   e04 <write>
    ...
    10a0:	e8 5f fd ff ff       	call   e04 <write>
    ...
    10d0:	e8 2f fd ff ff       	call   e04 <write>
    ...
    1120:	e8 df fc ff ff       	call   e04 <write>
...
000011c0 <malloc>:
    ...
    122a:	e8 3d fc ff ff       	call   e6c <sbrk>
